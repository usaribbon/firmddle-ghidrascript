...
public class NetWorkFunctionHeadless extends GhidraScript {
  ...
  public void getVals(FlatDecompilerAPI api, GhidraState s, TaskMonitor m, Program c, String logPath, int depth) throws Exception {
      ...
      try {  
      	...
      	fh = new FileHandler( directory.toString() + "/" + date.format(formatter_time) + "-NetWorkFunctionHeadless.log", true);
