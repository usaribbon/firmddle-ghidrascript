...
public class MemsetUserInputStringHeadless extends GhidraScript {
    ...
    public void getVals(FlatDecompilerAPI api, GhidraState s, TaskMonitor m, Program c, String logPath) throws Exception {
        ...
        try {  
        	...
        	fh = new FileHandler( directory.toString() + "/" + date.format(formatter_time) + "-MemsetUserInputStringHeadless.log", true);
    		...
    		try {
    	     	if (line.contains(var)) {//それ以外の変数なら代入されているか調べる!var.contains("'") && !var.contains("/") && 
                    ...
                    if(found) {
                		...
                		logger.info("FunctionName:"+functionName +", Line:"+str);
                        return true;
                    }
    	     	}    			
    		}catch (Exception e) {
