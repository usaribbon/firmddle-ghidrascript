...
public class YodaFunctionArgsChecker extends GhidraScript {
	...
	protected void run() throws Exception {
		...
		List<DecompileResults> fda = ParallelDecompiler.decompileFunctions(callback,
